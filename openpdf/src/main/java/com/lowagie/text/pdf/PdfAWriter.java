 ...
 * <P>
 * When this <CODE>PdfAWriter</CODE> is added
...
public class PdfAWriter extends PdfWriter {
     ...
     */
    protected PdfAWriter(PdfDocument document, OutputStream os) {
        super(document, os);
    }

    /**
     * Use this method to get an instance of the <CODE>PdfAWriter</CODE>.
     *
     * @param    document    The <CODE>Document</CODE> that has to be written
     * @param    os    The <CODE>OutputStream</CODE> the writer has to write to.
     * @return    a new <CODE>PdfAWriter</CODE>
     *
     * @throws    DocumentException on error
     */

    public static PdfAWriter getInstance(Document document, OutputStream os)
        throws DocumentException {
        PdfDocument pdf = new PdfDocument();
        pdf.setTextRenderingOptions(document.getTextRenderingOptions());
        document.addDocListener(pdf);
        PdfAWriter writer = new PdfAWriter(pdf, os);
